...
>;
export type SyncC2B = Omit<
	SyncResponse,
	'output_ResponseTransactionStatus' | 'output_CustomerName' | 'output_error'
>;

/**
 * B2C
 */
export type B2CParams = Omit<
	RequestParams,
	| 'input_TransactionID'
	| 'input_ReversalAmount'
	| 'input_InitiatorIdentifier'
 ...
 */
export type ReversalParams = Omit<
	RequestParams,
	| 'input_ReceiverPartyCode'
	| 'input_ServiceProviderCode'
	| 'input_QueryReference'
 ...
 */
export type QueryTransactionStatusParams = Omit<
	RequestParams,
	| 'input_ReceiverPartyCode'
	| 'input_ServiceProviderCode'
	| 'input_PrimaryPartyCode'
...
export type SyncTransactionStatus = Omit<
	SyncResponse,
	'output_CustomerName' | 'output_TransactionID' | 'output_error'
>;
/**
 * Query Customer Name
 */
export type CustomerNameParams = Omit<
	RequestParams,
	'input_Amount' | 'input_QueryReference' | 'input_TransactionReference'
>;
export type SyncCustomerName = Omit<
	SyncResponse,
	'output_ResponseTransactionStatus' | 'output_TransactionID' | 'output_error'
>;
...
export type AsyncResponse = {
	...
	input_ResponseTransactionStatus?:
		| 'Cancelled'
		| 'Completed'
		| 'Expired'
		| 'N/A';
